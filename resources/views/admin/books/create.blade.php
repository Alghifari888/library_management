<x-admin-layout>
    ...
    <form method="POST" action="{{ route('admin.books.store') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        @csrf
        ...
        <div>
            ...
            <x-text-input id="publisher" name="publisher" type="text" class="mt-1 block w-full" :value="old('publisher')" required />
        ...
        <div>
            ...
            <x-text-input id="publication_year" name="publication_year" type="number" class="mt-1 block w-full" :value="old('publication_year')" required placeholder="Contoh: 2023" />
        ...
        <div>
            ...
            <x-text-input id="isbn" name="isbn" type="text" class="mt-1 block w-full" :value="old('isbn')" required />
        ...
        <div>
            ...
            <x-text-input id="stock_quantity" name="stock_quantity" type="number" class="mt-1 block w-full" :value="old('stock_quantity', 0)" required min="0" />
        ...
        {{-- Sampul Buku --}}
        <div>
            <x-input-label for="cover_image" :value="__('Sampul Buku (Opsional)')" />
